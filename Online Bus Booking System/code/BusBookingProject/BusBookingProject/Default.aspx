...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="margin-top:6%">
        <div class="row">
            <div class="col-lg-12">
                <asp:Image ImageAlign="AbsMiddle" ImageUrl="https://www.smt.network/africa/content/uploads/2019/10/Volvo-Bus-SMT-Africa-2.jpg" style="width:100%" runat="server" />
            </div>
            <div class="col-lg-12" style="margin-top:2%">
                <div class="panel panel-default">
                    <div class="panel-heading">
                         <div class=" panel-title">
                        <h2><b>Introduction About Online Bus Booking</b></h2>
                    </div>
                       </div>
             ...
             <div class="col-lg-12" style="margin-top:2%">
                <div class="panel panel-default">
                    <div class="panel-heading">
                         <div class=" panel-title">
                      <h3><b>Why Online Bus Booking is Important?</b></h3>
                    </div>
                       </div>
                    <div class="panel-body" style="font-size: 20px">
                           <ul>
                               ...
                               <li>
                                   Hassle free and clean experiance.
                               </li>
                           </ul>
